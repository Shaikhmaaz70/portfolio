    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-5xl text-center">
        ...
        <p className="mx-auto mt-5 max-w-3xl text-[15px] sm:text-base md:text-xl lg:text-2xl text-white/85 leading-relaxed sm:leading-7 md:leading-8">
          Full Stack Web Developer with experience in building and deploying dynamic web applications. Skilled in{' '}
          <span className="font-semibold text-white">React.js</span>,{' '}
          <span className="font-semibold text-white">Node.js,Express.js</span>, and{' '}
          <span className="font-semibold text-white">MongoDB</span> with hands-on expertise in developing responsive front-ends, scalable back-ends, and efficient database solutions.
        </p>

        {/* Secondary line for credibility */}
        <p className="mx-auto mt-3 max-w-2xl text-sm sm:text-base md:text-lg text-white/70">
           I have 6 months of hands-on experience as a Full Stack Web Developer
        </p>
        ...
        <div className="mt-8 mx-auto w-full max-w-xl flex flex-col xs:flex-row items-stretch xs:items-center justify-center gap-3 sm:gap-4">
          <a
            ...
            aria-label="Contact M@@z"
          >
            Let&apos;s Connect
          </a>

          <a
            href="https://github.com/Shaikhmaaz70"
