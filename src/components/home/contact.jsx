      ...
      <div className="max-w-3xl w-full text-center">
        ...
        <form className="space-y-6">
          <input
            ...
            className="w-full p-3 rounded-lg border border-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 text-black"
            required
          />
          <input
            type="email"
        ...
        <div className="mt-10 text-gray-600">
          <p>Email: <a href="mailto:smaaz8398@gmail.com" className="text-orange-600 hover:underline">smaaz8398@gmail.com</a></p>
